...
import com.dariopellegrini.declarativerecycler.Differetiable
...
class MessageRow(val message: String, val click: (MessageRow) -> Unit): Row, Differetiable<MessageRow> {
